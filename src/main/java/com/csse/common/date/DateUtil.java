...
public class DateUtil {
     ...
     *
     * @param sdate 日期字符串
     * @param edate 另一个日期字符串
     * @return 相差天数。如果失败则返回-1
     */
    public static int getIntervalDays(String sdate, String edate) {
        return getIntervalDays(stringToDate(sdate), stringToDate(edate));
    }
    ...
    public static int getIntervalDays(Date sdate, Date edate) {
        int num = -1;
        Date dateTmp = stringToDate(DateUtil.getDate(sdate),
                DateStyle.YYYY_MM_DD);
        Date otherDateTmp = stringToDate(DateUtil.getDate(edate),
                DateStyle.YYYY_MM_DD);
    ...
    public static void main(String[] args) {
        ...
        System.out.println(getCurrentTimeMillis() / 1000);
